...
Brio `ActorSpawnService.CreateCharacter` 使用 `ClientObjectManager.CreateBattleCharacter` 创建本地 BattleCharacter，再从本地玩家复制 CharacterSetup。当前 LocalQuestReborn 在 Brio 3.0 环境实际命中 3 参数签名：
