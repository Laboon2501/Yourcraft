...
public sealed unsafe class NativeGameObjectDumpService
{
    ...
    public NativeNpcProbeSnapshot DumpActor(RuntimeActorInstance actor)
    {
        ...
        this.ActorSnapshot.Fields["RuntimeId"] = new(actor.RuntimeId, "Yourcraft RuntimeActorInstance");
        this.ActorSnapshot.Fields["NpcId"] = new(actor.NpcId, "Yourcraft RuntimeActorInstance");
        this.ActorSnapshot.Fields["Actor.ObjectIndex"] = new(actor.ObjectIndex, "Yourcraft RuntimeActorInstance");
        this.ActorSnapshot.Fields["Actor.Address"] = new(actor.Address, "Yourcraft RuntimeActorInstance");
