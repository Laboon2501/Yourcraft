...
public sealed class NativeNpcProbeService
{
    ...
    public NativeNpcProbeSnapshot SaveActorSnapshot(RuntimeActorInstance actor)
    {
        ...
        this.BrioActorSnapshot.Fields["RuntimeId"] = new(actor.RuntimeId, "Yourcraft RuntimeActorInstance");
        this.BrioActorSnapshot.Fields["NpcId"] = new(actor.NpcId, "Yourcraft RuntimeActorInstance");
        this.BrioActorSnapshot.Fields["Actor.ObjectIndex"] = new(actor.ObjectIndex, "Yourcraft RuntimeActorInstance");
        this.BrioActorSnapshot.Fields["Actor.Address"] = new(actor.Address, "Yourcraft RuntimeActorInstance");
